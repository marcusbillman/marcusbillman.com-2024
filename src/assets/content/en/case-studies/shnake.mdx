...
date: '2020'
cover:
  astroImage: '@/assets/images/content/shnake/cover.png'
  alt: Showcase of various UI elements and the game in a green, bubbly theme
locale: en
orderRank: 70
---

import themesImage from '@/assets/images/content/shnake/themes.png';
import uiImage from '@/assets/images/content/shnake/ui.gif';
